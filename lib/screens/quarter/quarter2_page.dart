...
class Quarter2Page extends StatelessWidget {
  const Quarter2Page({super.key});
          ...
          child: Column(
            children: [
              ...
              ErrorInfo(
                title: "Coming Soon!",
                description:
                    "We are currently working on new content. Please check back later. Thank you for your patience.",
            ...
            button ??
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: const Color(0xFF329494),
                    foregroundColor: Colors.white,
                    shape: const RoundedRectangleBorder(
                      borderRadius: BorderRadius.all(Radius.circular(8)),
                    ),
                  ),
                  child: Text(btnText ?? "Back".toUpperCase()),
                ),
            const SizedBox(height: 16),
          ],
        ),
